...
void triangle(float xCoin1,float yCoin1, float xCoin2,float yCoin2, float xCoin3,float yCoin3, int filled);

/* Dessine un rectangle de couleur courante aux coordonnees donnees */
void rectangle(float xCoin1,float yCoin1, float xCoin2,float yCoin2, int filled);

// ============================= HERE IS ADDED ===========================

void quad(float x1,float y1, float x2,float y2, float x3,float y3, float x4,float y4, int filled);

/* Dessine un point de couleur courante aux coordonnees donnees */
void pointRGB(float x,float y, int r,int g,int b);

/* Dessine une ligne de couleur courante aux coordonnees donnees */
void ligneRGB(float xDepart,float yDepart, float xArrivee,float yArrivee, int r,int g,int b);

// Dessine un triangle de couleur courante aux coordonnees donnees
void triangleRGB(float xCoin1,float yCoin1, float xCoin2,float yCoin2, float xCoin3,float yCoin3, int filled, int r,int g,int b);

/* Dessine un rectangle de couleur courante aux coordonnees donnees */
void rectangleRGB(float xCoin1,float yCoin1, float xCoin2,float yCoin2, int filled, int r,int g,int b);
...
img readRGBA2ARVB(char name[20], img image);

void ecrisImageIMG(int x, int y, img image);
